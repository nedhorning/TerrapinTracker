...
float maxEPE = 15.0;   // Maximum EPE value that will be used to keep GPS coordinates
...
uint32_t highTideCycle = 1224;  //For testing
...
{
       myTimerResume.start(callbackResume, 1000, (myPeriodHT * 1000));
       startHT_Time = millis();
...
{
    myTimerResume.start(callbackResume, (myPeriodLT * 1000));
}
