...
uint8_t highTideRefDay = 1;
uint8_t highTideRefHour = 0;  // 24 hour clock
uint8_t highTideRefMinute = 20;
uint8_t highTideRefSecond = 0;

uint32_t refHighTide;  // Number of second from beginning of year to reference high tide 
uint32_t millisNextHighTide;
int16_t secBeforeHTStart; // Seconds befor starting high tide cycles
